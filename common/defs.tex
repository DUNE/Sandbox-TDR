...
\def\voltitlephys{Volume 2: The Physics Program for DUNE at LBNF\xspace}
\def\voltitlespfdoverview{Volume 3: The Single-Phase Far Detector Overview\xspace}
\def\voltitlespfdapa{Volume 3A: The Single-Phase Far Detector Anode Plane Assemblies\xspace}


% For use within volumes (italicized)
\def\volexecsumm{Volume 1: \textit{Executive Summary\xspace}}
\def\volphys{Volume 2: \textit{The Physics Program for DUNE at LBNF\xspace}}
\def\volspfdoverview{Volume 3: \textit{The Single-Phase Far Detector Overview\xspace}}
\def\volspfdapa{Volume 3A: \textit{The Single-Phase Far Detector Anode Plane Assemblies\xspace}}
